...
<a href="#popup-feedback"  data-transition="slideup" data-rel="popup" class="ui-btn ui-corner-all ui-alt-icon ui-shadow ui-btn-inline" data-position-to="window" title="Feedback Received">Feedback Received</a>
<a href="#popup-a"  data-transition="slideup" data-rel="popup" class="ui-btn ui-corner-all ui-alt-icon ui-shadow ui-btn-inline" title="Feedback Received">Account Update History</a>
<a href="#popup-b"  data-transition="slideup" data-rel="popup" class="ui-btn ui-corner-all ui-alt-icon ui-shadow ui-btn-inline" title="Feedback Received">Login History</a>
<a href="#popup-c"  data-transition="slideup" data-rel="popup" class="ui-btn ui-corner-all ui-alt-icon ui-shadow ui-btn-inline" title="Feedback Received">Login Attempts</a>
<a href="#popup-d"  data-transition="slideup" data-rel="popup" class="ui-btn ui-corner-all ui-alt-icon ui-shadow ui-btn-inline" title="Feedback Received">Password Request History</a>		
		
<div data-role="popup" id="popup-feedback" data-theme="a" class="ui-content">		
	<form>
...
<%--Using JSTL to draw user table from the database--%>        
            <c:forEach items="<%=dao.getAllFeedbacks()%>" var="feedback">
                    ...
                    <td><c:out value="${feedback.updateTime}" /></td>                
