...
<!-- White Paragraph  -->					
	...
	<h4 id="heading-1" class="ui-bar ui-bar-a ui-corner-all" align="left">Feedback Received</h4>
	
		<div data-role="content"  class="ui-body ui-body-a ui-corner-all" >
		<p>Search can be used to filter types, categories or received dates of feedback.</p>
	<form>
